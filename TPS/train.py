...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data', default='result/train',help='path to training dataset')
    parser.add_argument('--valid_data', default='result/evaluation',help='path to validation dataset')
