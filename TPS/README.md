...
3. train our model
```
python train.py --train_data result/train --valid_data result/evaluation --Transformation TPS --Fea
tureExtraction ResNet --SequenceModeling BiLSTM --Prediction Attn
```
